    ...
    class SentItem
    {
        ...
        public static List<SentItem> ParseNearItems(Pullenti.Ner.Token t, Pullenti.Ner.Token t1, int lev, List<SentItem> prev)
        {
            ...
            if ((t111 is Pullenti.Ner.NumberToken) && ((t111.Morph.Class.IsAdjective && !t111.Morph.Class.IsNoun))) 
                t111 = null;
            Pullenti.Ner.Measure.Internal.NumbersWithUnitToken num = (t111 == null ? null : Pullenti.Ner.Measure.Internal.NumbersWithUnitToken.TryParse(t111, null, Pullenti.Ner.Measure.Internal.NumberWithUnitParseAttr.No));
            if (num != null) 
            {
