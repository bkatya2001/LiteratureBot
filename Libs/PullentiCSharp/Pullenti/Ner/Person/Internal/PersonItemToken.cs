    ...
    public class PersonItemToken : Pullenti.Ner.MetaToken
    {
        ...
        public bool IsAsianItem(bool last)
        {
            ...
            if (Value.Length == 1) 
            {
                ...
                return false;
            if (Value.Length > 5 && BeginToken == EndToken && !last) 
            {
                Pullenti.Morph.MorphClass mc = BeginToken.GetMorphClassInDictionary();
                if (!mc.IsUndefined) 
                    return false;
            }
            return true;
        ...
        public class MorphPersonItem
        {
            ...
            public void CorrectLastnameVariants()
            {
                ...
                bool strongStd = false;
                foreach (Pullenti.Ner.Person.Internal.PersonItemToken.MorphPersonItemVariant v in Vars) 
                {
                    if (v.Value != null) 
                    {
                        if (EndsWithStdSurname(v.Value) || Pullenti.Morph.LanguageHelper.EndsWith(v.Value, "АЯ") || Pullenti.Morph.LanguageHelper.EndsWith(v.Value, "ОЙ")) 
                        {
                            IsLastnameHasStdTail = true;
                            strongStd = true;
                            break;
                        }
                        else if (Pullenti.Morph.LanguageHelper.EndsWith(v.Value, "КИЙ") || Pullenti.Morph.LanguageHelper.EndsWith(v.Value, "ЫЙ")) 
                            IsLastnameHasStdTail = true;
                    }
                }
                if (IsLastnameHasStdTail) 
                {
                    for (int i = Vars.Count - 1; i >= 0; i--) 
                    {
                        ...
                        {
                            if (!Vars[i].Class.IsProperSurname || strongStd) 
                            {
                                Vars.RemoveAt(i);
                                continue;
                            }
        ...
        public static PersonItemToken TryAttach(Pullenti.Ner.Token t, ParseAttr attrs = ParseAttr.No, List<PersonItemToken> prevList = null)
        {
            if (t == null) 
                return null;
            ...
            if (t is Pullenti.Ner.NumberToken) 
            {
                ...
                {
                    PersonItemToken res00 = TryAttach(nt.BeginToken, attrs, prevList);
                    if (res00 != null) 
                    {
                        res00.BeginToken = (res00.EndToken = t);
                        return res00;
            ...
            if (t is Pullenti.Ner.ReferentToken) 
            {
                ...
                {
                    PersonItemToken res00 = TryAttach(rt.BeginToken, attrs, prevList);
                    if (res00 != null) 
                    {
                        PersonItemToken res01 = TryAttach(t.Next, attrs, prevList);
            ...
            if (t.Chars.IsLatinLetter && ((attrs & ParseAttr.CanBeLatin)) != ParseAttr.No) 
            {
                ...
                if (ad != null) 
                    ots = ad.LocalOntology.TryAttach(t, Pullenti.Ner.Person.PersonReferent.OBJ_TYPENAME, false);
                if (t != null && t.Kit.Ontology != null && ots == null) 
                    ots = t.Kit.Ontology.AttachToken(Pullenti.Ner.Person.PersonReferent.OBJ_TYPENAME, t);
            ...
            if (((((t is Pullenti.Ner.TextToken) && t.LengthChar == 1 && t.Chars.IsLetter) && t.Chars.IsAllUpper && (t.WhitespacesAfterCount < 2)) && (t.Next is Pullenti.Ner.TextToken) && t.Next.LengthChar == 1) && t.Next.Chars.IsAllLower) 
            {
                ...
                if (cou < 5) 
                {
                    ...
                    {
                        PersonItemToken ne = TryAttach(t1.Next, attrs, null);
            ...
            if (((t.Chars.IsAllUpper && (t is Pullenti.Ner.TextToken) && t.LengthChar == 1) && prevList != null && prevList.Count > 0) && (t.WhitespacesBeforeCount < 2) && prevList[0].Chars.IsCapitalUpper) 
            {
        ...
        static PersonItemToken _tryAttach(Pullenti.Ner.Token t, ParseAttr attrs, List<PersonItemToken> prevList = null)
        {
            Pullenti.Ner.TextToken tt = t as Pullenti.Ner.TextToken;
            if (tt == null) 
            {
                if (t.Chars.IsLetter && t.Chars.IsCapitalUpper && (t is Pullenti.Ner.ReferentToken)) 
                {
                    ...
                    {
                        PersonItemToken res0 = _tryAttach(rt.BeginToken, attrs, null);
                        if (res0 == null) 
                        {
                        ...
                        {
                            PersonItemToken res1 = TryAttach(t.Next.Next, ParseAttr.No, null);
            ...
            if (tt.LengthChar == 1 || tt.Term == "ДЖ") 
            {
                ...
                if ((tt.Next.WhitespacesAfterCount < 2) && (tt.WhitespacesAfterCount < 2) && ((tt.Term == "Д" || tt.Term == "О" || tt.Term == "Н"))) 
                {
                    if (Pullenti.Ner.Core.BracketHelper.IsBracket(tt.Next, false) && (tt.Next.Next is Pullenti.Ner.TextToken)) 
                    {
                        ...
                        {
                            PersonItemToken pit0 = TryAttach(tt.Next.Next, attrs | ParseAttr.CanBeLower, prevList);
                            if (pit0 != null) 
                            {
                                pit0.BeginToken = tt;
                                if (pit0.Value != null) 
            ...
            if (ots != null) 
            {
                ...
                res.Lastname.Term = ots[0].Termin.CanonicText.Replace(" - ", "-");
                res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValueOfMetaToken(ots[0], Pullenti.Ner.Core.GetTextAttr.No);
                foreach (Pullenti.Ner.Core.IntOntologyToken ot in ots) 
                {
                    if (ot.Termin != null) 
                    {
                ...
                if (m_SurPrefixes.Contains(tt.Term)) 
                {
                    ...
                    else 
                    {
                        if (tt.Next != null) 
                        {
                            ...
                            if ((t1 is Pullenti.Ner.TextToken) && (((t1 as Pullenti.Ner.TextToken).Term == "Л" || (t1 as Pullenti.Ner.TextToken).Term == "ЛЬ" || m_SurPrefixes.Contains((t1 as Pullenti.Ner.TextToken).Term)))) 
                            {
                                res.EndToken = t1;
                                res.Value += (t1 as Pullenti.Ner.TextToken).Term;
                                t1 = t1.Next;
                            }
                            else if ((t1.IsHiphen && (t1.Next is Pullenti.Ner.TextToken) && t1.Next.Next != null) && (((t1.Next as Pullenti.Ner.TextToken).Term == "Л" || (t1.Next as Pullenti.Ner.TextToken).Term == "ЛЬ" || m_SurPrefixes.Contains((t1.Next as Pullenti.Ner.TextToken).Term)))) 
                            {
                                res.EndToken = t1.Next;
                                res.Value += (t1.Next as Pullenti.Ner.TextToken).Term;
                                t1 = t1.Next.Next;
                            }
                            if (t1 != null && t1.IsHiphen) 
                                tt = t1.Next as Pullenti.Ner.TextToken;
                            else if (((attrs & ParseAttr.SurnamePrefixNotMerge)) != ParseAttr.No && t1 != null && t1.Chars.IsAllLower) 
                                tt = null;
                            else 
                ...
                if (tt.Morph.Class.IsAdjective && !res.Lastname.IsInOntology) 
                {
                    ...
                    if (!stdEnd && (tt.WhitespacesAfterCount < 2)) 
                    {
                        ...
                        if (npt != null && npt.EndToken != npt.BeginToken) 
                        {
                            ...
                            {
                                PersonItemToken nex = _tryAttach(npt.EndToken, attrs, null);
            ...
            if (res.EndToken.Next != null && res.EndToken.Next.IsHiphen && (res.EndToken.Next.Next is Pullenti.Ner.TextToken)) 
            {
                ...
                {
                    PersonItemToken res1 = TryAttach(res.EndToken.Next.Next, ParseAttr.No, null);
        ...
        public static List<string> m_SurPrefixes = new List<string>(new string[] {"АБД", "АБУ", "АБУЛЬ", "АБДУ", "АБДЕЛЬ", "УММ", "АЛ", "АЛЬ", "АН", "АТ", "АР", "АС", "АД", "БИН", "БЕН", "ИБН", "УЛЬД", "БИНТ", "ФОН", "ВАН", "ДЕ", "ДИ", "ДА", "ЛА", "ЛЕ", "ЛЯ", "ЭЛЬ", "УЛЬ"});
        static List<string> m_SurPrefixesLat = new List<string>(new string[] {"ABD", "AL", "BEN", "IBN", "VON", "VAN", "DE", "DI", "LA", "LE", "DA", "DE"});
        public static List<string> m_ArabPostfix = new List<string>(new string[] {"АГА", "АЛИ", "АР", "АС", "АШ", "БЕЙ", "БЕК", "ЗАДЕ", "ОГЛЫ", "ОГЛИ", "УГЛИ", "ОЛЬ", "ООЛ", "ПАША", "БАША", "УЛЬ", "УЛЫ", "УУЛУ", "ХАН", "ХАДЖИ", "ШАХ", "ЭД", "ЭЛЬ"});
        ...
        public static List<PersonItemToken> TryAttachList(Pullenti.Ner.Token t, ParseAttr attrs = ParseAttr.No, int maxCount = 10)
        {
            if (t == null) 
                return null;
            ...
            for (; t != null; t = (t == null ? null : t.Next)) 
            {
                ...
                else if ((tt.IsChar('(') && (tt.Next is Pullenti.Ner.TextToken) && tt.Next.Chars.Equals(tt.Previous.Chars)) && tt.Next.Next != null && tt.Next.Next.IsChar(')')) 
                {
                    PersonItemToken pit0 = res[res.Count - 1];
                    PersonItemToken pit11 = TryAttach(tt.Next, attrs, null);
                    ...
                    else if (pit0.Firstname == null && pit0.Lastname != null && ((pit0.Lastname.IsInDictionary || pit0.Lastname.IsLastnameHasStdTail || pit0.Lastname.IsHasStdPostfix))) 
                    {
                        if (pit11 != null && pit11.Lastname != null) 
                        {
                            ...
                            {
                                PersonItemToken pit22 = TryAttach(tt.Next.Next.Next, attrs, null);
                                if (pit22 != null) 
                                {
                ...
                {
                    if (((attrs & ParseAttr.IgnoreAttrs)) == ParseAttr.No) 
                    {
                        PersonAttrToken pat = PersonAttrToken.TryAttach(pit1.BeginToken, PersonAttrToken.PersonAttrAttachAttrs.No);
                        if (pat != null) 
                        {
            ...
            if (res.Count == 1 && res[0].IsNewlineBefore && res[0].IsNewlineAfter) 
            {
                ...
                {
                    List<PersonItemToken> res1 = TryAttachList(res[0].EndToken.Next, ParseAttr.CanBeLatin, maxCount);
                    if (res1 != null && res1.Count > 0) 
                    {
                        ...
                        {
                            List<PersonItemToken> res2 = TryAttachList(res1[0].EndToken.Next, ParseAttr.CanBeLatin, maxCount);
        ...
        public static Pullenti.Ner.ReferentToken TryParsePerson(Pullenti.Ner.Token t, FioTemplateType prevPersTemplate = FioTemplateType.Undefined)
        {
            ...
            if (t.GetReferent() is Pullenti.Ner.Person.PersonReferent) 
            {
                ...
                if (rt.BeginToken == rt.EndToken) 
                {
                    ...
                    {
                        List<PersonItemToken> pits0 = PersonItemToken.TryAttachList(tt1, ParseAttr.CanInitialBeDigit, 10);
            ...
            List<PersonItemToken> pits = PersonItemToken.TryAttachList(t, ParseAttr.CanInitialBeDigit | ParseAttr.CanBeLatin, 10);
            if ((pits == null && (t is Pullenti.Ner.TextToken) && t.Chars.IsAllLower) && t.LengthChar > 3) 
            {
                PersonItemToken pi = PersonItemToken.TryAttach(t, ParseAttr.CanInitialBeDigit | ParseAttr.CanBeLatin | ParseAttr.CanBeLower, null);
                if (pi != null && pi.Lastname != null && ((pi.Lastname.IsInDictionary || pi.Lastname.IsLastnameHasStdTail))) 
                {
                    pits = PersonItemToken.TryAttachList(pi.EndToken.Next, ParseAttr.CanInitialBeDigit | ParseAttr.CanBeLatin, 10);
            ...
            if (pits != null && prevPersTemplate != FioTemplateType.Undefined && pits[0].Typ == ItemType.Value) 
            {
                ...
                {
                    List<PersonItemToken> ppp = PersonItemToken.TryAttachList(pits[0].EndToken.Next, ParseAttr.CanBeLatin, 10);
            ...
            if (pits != null && pits.Count == 1 && pits[0].Typ == ItemType.Value) 
            {
                ...
                {
                    List<PersonItemToken> pits1 = PersonItemToken.TryAttachList(tt, ParseAttr.CanInitialBeDigit | ParseAttr.CanBeLatin, 10);
