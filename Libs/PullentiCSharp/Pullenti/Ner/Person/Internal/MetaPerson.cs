...
namespace Pullenti.Ner.Person.Internal
{
    class MetaPerson : Pullenti.Ner.Metadata.ReferentClass
    {
        ...
        public static void Initialize()
        {
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Person.PersonReferent.ATTR_UNDEFNAME, "Непонятно что", 0, 0);
            GlobalMeta.AddFeature(Pullenti.Ner.Person.PersonReferent.ATTR_NAMETYPE, "Тип именования", 0, 0);
