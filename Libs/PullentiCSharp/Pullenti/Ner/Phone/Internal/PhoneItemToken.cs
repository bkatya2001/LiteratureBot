...
namespace Pullenti.Ner.Phone.Internal
{
    ...
    public class PhoneItemToken : Pullenti.Ner.MetaToken
    {
        ...
        public Pullenti.Ner.Phone.PhoneKind Kind2 = Pullenti.Ner.Phone.PhoneKind.Undefined;
        ...
        public override string ToString()
        {
            ...
            res.AppendFormat("{0}: {1}", ItemType, Value);
            if (Kind != Pullenti.Ner.Phone.PhoneKind.Undefined) 
                res.AppendFormat(" ({0})", Kind);
            if (Kind2 != Pullenti.Ner.Phone.PhoneKind.Undefined) 
                res.AppendFormat(" ({0})", Kind2);
            return res.ToString();
        }
        ...
        static PhoneItemToken _TryAttach(Pullenti.Ner.Token t0)
        {
            ...
            if (t0 is Pullenti.Ner.NumberToken) 
            {
                ...
                {
                    Pullenti.Ner.ReferentToken rt = t0.Kit.ProcessReferent("PHONE", t0.Next, null);
                    if (rt == null) 
                        return null;
                }
            ...
            while (true) 
            {
                ...
                {
                    res.Kind2 = Pullenti.Ner.Phone.PhoneKind.Fax;
