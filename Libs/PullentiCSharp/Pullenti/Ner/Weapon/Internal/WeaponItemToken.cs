        ...
        static WeaponItemToken _TryParse(Pullenti.Ner.Token t, WeaponItemToken prev, bool afterConj, bool attachHigh = false)
        {
            ...
            if (tok != null) 
            {
                ...
                if (res.Typ == Typs.Noun) 
                {
                    ...
                    for (Pullenti.Ner.Token tt = res.EndToken.Next; tt != null; tt = tt.Next) 
                    {
                        ...
                        if (mc.Equals(Pullenti.Morph.MorphClass.Adjective)) 
                        {
                            if (res.AltValue == null) 
            ...
            if (t.IsValue("КАЛИБР", "КАЛІБР")) 
            {
                ...
                if (tt1 != null && ((tt1.IsHiphen || tt1.IsChar(':')))) 
                    tt1 = tt1.Next;
                Pullenti.Ner.Measure.Internal.NumbersWithUnitToken num = Pullenti.Ner.Measure.Internal.NumbersWithUnitToken.TryParse(tt1, null, Pullenti.Ner.Measure.Internal.NumberWithUnitParseAttr.No);
            ...
            {
                Pullenti.Ner.Measure.Internal.NumbersWithUnitToken num = Pullenti.Ner.Measure.Internal.NumbersWithUnitToken.TryParse(t, null, Pullenti.Ner.Measure.Internal.NumberWithUnitParseAttr.No);
                if (num != null && num.SingleVal != null) 
                {
