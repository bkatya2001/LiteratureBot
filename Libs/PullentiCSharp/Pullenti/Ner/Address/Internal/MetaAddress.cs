...
namespace Pullenti.Ner.Address.Internal
{
    class MetaAddress : Pullenti.Ner.Metadata.ReferentClass
    {
        public static void Initialize()
        {
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_HOUSEORPLOT, "Дом или участок", 0, 1);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_PAVILION, "Павильон", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_PLOT, "Участок", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_FIELD, "Поле", 0, 1);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_DETAILREF, "Объект детализации", 0, 1);
