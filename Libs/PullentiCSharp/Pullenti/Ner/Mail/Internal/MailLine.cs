    ...
    public class MailLine : Pullenti.Ner.MetaToken
    {
        ...
        public static MailLine Parse(Pullenti.Ner.Token t0, int lev, int maxCount = 0)
        {
            ...
            if (res.Typ == Types.Undefined) 
            {
                ...
                for (; t != null && (t.EndChar < res.EndChar); t = t.Next) 
                {
                    ...
                    if (t is Pullenti.Ner.TextToken) 
                    {
                        ...
                        if (tok != null && (t is Pullenti.Ner.TextToken) && t.IsValue("ДОРОГОЙ", null)) 
                        {
                            if ((t as Pullenti.Ner.TextToken).Term == "ДОРОГОЙ" || (t as Pullenti.Ner.TextToken).Term == "ДОРОГАЯ" || (t as Pullenti.Ner.TextToken).Term == "ДОРОГИЕ") 
                            {
                            }
                            else 
                                tok = null;
                        ...
                        Pullenti.Ner.Person.Internal.PersonItemToken pit = Pullenti.Ner.Person.Internal.PersonItemToken.TryAttach(t, Pullenti.Ner.Person.Internal.PersonItemToken.ParseAttr.No, null);
                        if (pit != null) 
                        {
                            nams++;
                            t = pit.EndToken;
            ...
            if (res.Typ == Types.Undefined) 
            {
                ...
                for (Pullenti.Ner.Token t = t0; t != null && t.EndChar <= res.EndChar; t = (t == null ? null : t.Next)) 
                {
                    if (!(t is Pullenti.Ner.TextToken)) 
                        continue;
                    if (t.IsChar('<')) 
