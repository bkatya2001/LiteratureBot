...
namespace Pullenti.Ner.Date.Internal
{
    internal class MetaDate : Pullenti.Ner.Metadata.ReferentClass
    {
        public static void Initialize()
        {
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Date.DateReferent.ATTR_DECADE, "Декада", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Date.DateReferent.ATTR_YEAR, "Год", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Date.DateReferent.ATTR_HALFYEAR, "Полугодие", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Date.DateReferent.ATTR_QUARTAL, "Квартал", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Date.DateReferent.ATTR_SEASON, "Сезон", 0, 1);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Date.DateReferent.ATTR_NEWSTYLE, "Дата нового стиля", 0, 1);
