...
namespace Pullenti.Ner.Measure.Internal
{
    public static class UnitsHelper
    {
        ...
        public static void Initialize()
        {
            ...
            u = new Unit("раз", "times", "раз", "times") { Kind = Pullenti.Ner.Measure.MeasureKind.Count };
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("РАЗ") { Tag = u };
            Termins.Add(t);
            ...
            Termins.Add(t);
            uu = new Unit("квартал", "quarter", "квартал", "quarter") { BaseUnit = u, BaseMultiplier = 91, Kind = Pullenti.Ner.Measure.MeasureKind.Time };
            Units.Add(uu);
            t = new Pullenti.Ner.Core.Termin("КВАРТАЛ") { Tag = uu };
            ...
            Termins.Add(t);
            uu = new Unit("декада", "decade", "декада", "decade") { BaseUnit = u, BaseMultiplier = 365 * 10, Kind = Pullenti.Ner.Measure.MeasureKind.Time };
            Units.Add(uu);
            t = new Pullenti.Ner.Core.Termin("ДЕКАДА") { Tag = uu };
