    ...
    public class OrganizationAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        static Pullenti.Ner.ReferentToken AttachGlobalOrg(Pullenti.Ner.Token t, AttachType attachTyp, object extGeo = null)
        {
            if ((t is Pullenti.Ner.TextToken) && t.Chars.IsLatinLetter) 
            {
                ...
                {
                    Pullenti.Ner.ReferentToken res11 = AttachGlobalOrg(t.Next, attachTyp, extGeo);
                    if (res11 != null) 
                    {
                        res11.BeginToken = t;
                        return res11;
            ...
            Pullenti.Ner.ReferentToken rt00 = TryAttachPoliticParty(t, true);
            if (rt00 != null) 
                return rt00;
            if (!(t is Pullenti.Ner.TextToken)) 
            {
                ...
                {
                    Pullenti.Ner.ReferentToken rt = AttachGlobalOrg((t as Pullenti.Ner.ReferentToken).BeginToken, attachTyp, null);
            ...
            if (t.Chars.IsAllUpper && term == "ВС") 
            {
                if (t.Previous != null) 
                {
                    if (t.Previous.IsValue("ПРЕЗИДИУМ", null) || t.Previous.IsValue("ПЛЕНУМ", null) || t.Previous.IsValue("СЕССИЯ", null)) 
                    {
                        ...
                        Pullenti.Ner.Token te = AttachTailAttributes(org00, t.Next, false, AttachType.Normal, true);
                        if (org00.GeoObjects.Count == 1 && org00.GeoObjects[0].Alpha2 == "SU") 
                        {
            ...
            if ((t.Chars.IsAllUpper && ((term == "АН" || term == "ВАС" || term == "АМН")) && t.Next != null) && (t.Next.GetReferent() is Pullenti.Ner.Geo.GeoReferent)) 
            {
                OrganizationReferent org00 = new OrganizationReferent();
                if (term == "АН") 
                {
            ...
            {
                Pullenti.Ner.ReferentToken rt = t.Kit.ProcessReferent("PERSONPROPERTY", t.Previous, null);
            ...
            foreach (Pullenti.Ner.Core.IntOntologyToken ot in gt) 
            {
                ...
                if (ot.BeginToken == ot.EndToken) 
                {
                    if (gt.Count == 1) 
                    {
                        ...
                        {
                            Pullenti.Ner.Org.Internal.OrgItemTypeToken ty = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(ot.BeginToken, false);
                            if (ty != null) 
                                continue;
                        }
                    }
                ...
                if (((t.Chars.IsAllLower && attachTyp != AttachType.ExtOntology && extGeo == null) && !t.IsValue("МИД", null) && !org0._typesContains("факультет")) && org0.Kind != OrganizationKind.Justice) 
                {
                    ...
                    if (ot.Morph.Number == Pullenti.Morph.MorphNumber.Plural) 
                        continue;
                    Pullenti.Ner.Org.Internal.OrgItemTypeToken tyty = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t, true);
                ...
                if (ot.BeginToken == ot.EndToken) 
                {
                    ...
                    Pullenti.Ner.ReferentToken rt = t.Kit.ProcessReferent("TRANSPORT", t, null);
                    if (rt != null) 
                        continue;
                }
                OrganizationReferent org = null;
                ...
                {
                    Pullenti.Ner.ReferentToken gg = t.Kit.ProcessReferent("GEO", t.Previous, null);
                ...
                if (!org0.Types.Contains("академия") && attachTyp != AttachType.NormalAfterDep && attachTyp != AttachType.ExtOntology) 
                    t1 = AttachTailAttributes(org, ot.EndToken.Next, false, AttachType.Normal, true);
                ...
                {
                    Pullenti.Ner.Org.Internal.OrgItemTypeToken typ = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t1.Next, false);
                    if (typ != null) 
                    {
                        if (Pullenti.Ner.Org.Internal.OrgItemTypeToken.IsTypeAccords(org, typ)) 
                        {
                            ...
                            else if (OrganizationAnalyzer.ProcessReferentStat(t1.Next, null) != null) 
                            {
                            }
                            else 
                            {
                ...
                {
                    Pullenti.Ner.ReferentToken grt = t.Kit.ProcessReferent("GEO", t.Previous, null);
        ...
        static Pullenti.Ner.ReferentToken TryAttachOrgMed(Pullenti.Ner.Token t)
        {
            if (t == null) 
                return null;
        ...
        static Pullenti.Ner.ReferentToken TryAttachPropNames(Pullenti.Ner.Token t)
        {
            Pullenti.Ner.ReferentToken rt = _tryAttachOrgSportAssociations(t);
            if (rt == null) 
            ...
            {
                Pullenti.Ner.ReferentToken rt0 = t0.Kit.ProcessReferent("GEO", t0, null);
            ...
            {
                Pullenti.Ner.Token tt1 = AttachTailAttributes(rt.Referent as OrganizationReferent, rt.EndToken.Next, true, AttachType.Normal, true);
                if (tt1 != null) 
                    rt.EndToken = tt1;
            }
            return rt;
        }
        static Pullenti.Ner.ReferentToken _tryAttachOrgNames(Pullenti.Ner.Token t)
        {
            if (t == null) 
                return null;
            Pullenti.Ner.Token t0 = t;
            ...
            else if (t.Chars.IsAllUpper && (t as Pullenti.Ner.TextToken).Term == "ИА") 
            {
                ...
                if (t == null || t.WhitespacesBeforeCount > 2) 
                    return null;
                Pullenti.Ner.ReferentToken re = _tryAttachOrgNames(t);
                if (re != null) 
                {
                    re.BeginToken = t0;
            ...
            if (br != null) 
            {
                ...
                {
                    Pullenti.Morph.MorphClass mc = tt.GetMorphClassInDictionary();
                    if (mc.Equals(Pullenti.Morph.MorphClass.Verb)) 
                        return null;
                    if (mc.Equals(Pullenti.Morph.MorphClass.Adverb)) 
                        return null;
                    if (tt.IsCharOf("?:")) 
                        return null;
        ...
        static Pullenti.Ner.ReferentToken _tryAttachOrgSportAssociations(Pullenti.Ner.Token t)
        {
            if (t == null) 
                return null;
            int cou = 0;
        ...
        static Pullenti.Ner.ReferentToken TryAttachArmy(Pullenti.Ner.Token t)
        {
            if (!(t is Pullenti.Ner.NumberToken) || t.WhitespacesAfterCount > 2) 
                return null;
            Pullenti.Ner.Org.Internal.OrgItemTypeToken typ = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t.Next, true);
            if (typ == null) 
                return null;
            if (typ.Root != null && typ.Root.Profiles.Contains(OrgProfile.Army)) 
            {
                Pullenti.Ner.ReferentToken rt = TryAttachOrg(t.Next, AttachType.High, null, false, -1);
                if (rt != null) 
                {
        ...
        {
            return new Pullenti.Ner.Org.Internal.OrgAnalyzerData();
        }
        internal static Pullenti.Ner.Org.Internal.OrgAnalyzerData GetData(Pullenti.Ner.Token t)
        {
            if (t == null) 
                return null;
            return t.Kit.GetAnalyzerDataByAnalyzerName(ANALYZER_NAME) as Pullenti.Ner.Org.Internal.OrgAnalyzerData;
        }
        public override void Process(Pullenti.Ner.Core.AnalysisKit kit)
        {
            Pullenti.Ner.Org.Internal.OrgAnalyzerData ad = kit.GetAnalyzerData(this) as Pullenti.Ner.Org.Internal.OrgAnalyzerData;
            ...
            Pullenti.Ner.Org.Internal.OrgItemTypeToken.SpeedRegime = true;
            Pullenti.Ner.Org.Internal.OrgItemTypeToken.PrepareAllData(kit.FirstToken);
            ad.TRegime = true;
            ...
            for (int step = 0; step < steps; step++) 
            {
                ...
                for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next) 
                {
                    ...
                    {
                        List<Pullenti.Ner.ReferentToken> rts = TryAttachOrgs(t, step);
                    ...
                    if (step > 0) 
                    {
                        Pullenti.Ner.ReferentToken rt = CheckOwnership(t);
                        if (rt != null) 
                        {
                            kit.EmbedToken(rt);
                            t = rt;
                    ...
                    if ((t is Pullenti.Ner.ReferentToken) && (t.GetReferent() is OrganizationReferent)) 
                    {
                        ...
                        {
                            Pullenti.Ner.ReferentToken rt00 = this.TryAttachOrgBefore(rt0);
                            if (rt00 == null) 
                                break;
                            rt0 = rt00;
                            _doPostAnalyze(rt0);
                    ...
                    if (org.Higher == null) 
                    {
                        if (!Pullenti.Ner.Org.Internal.OrgOwnershipHelper.CanBeHigher(org1, org, false)) 
                        {
                            if (t1.Previous != t || t1.WhitespacesAfterCount > 2) 
                                continue;
                            Pullenti.Ner.ReferentToken pp = t.Kit.ProcessReferent("PERSON", t1.Next, null);
                            if (pp != null) 
                            {
                            }
                            else 
        ...
        public static Pullenti.Ner.ReferentToken ProcessReferentStat(Pullenti.Ner.Token begin, string param = null)
        {
            if (begin == null) 
                return null;
            Pullenti.Ner.Org.Internal.OrgAnalyzerData ad = GetData(begin);
            if (ad == null) 
                return null;
            if (ad.Level > 2) 
                return null;
            ...
            {
                ad.Level++;
                Pullenti.Ner.Org.Internal.OrgItemTypeToken ty = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(begin, false);
                ad.Level--;
                if (ty != null && ty.BeginToken == begin) 
                {
                    OrganizationReferent org = new OrganizationReferent();
                    org.AddType(ty, false);
                    return new Pullenti.Ner.ReferentToken(org, begin, ty.EndToken) { Morph = ty.Morph };
                }
            }
            if (param == "MINTYPE") 
            {
                ad.Level++;
                Pullenti.Ner.Org.Internal.OrgItemTypeToken ty = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttachPureKeywords(begin);
                ad.Level--;
                if (ty == null) 
                    return null;
                OrganizationReferent org = new OrganizationReferent();
            ...
            ad.Level++;
            Pullenti.Ner.ReferentToken rt = TryAttachOrg(begin, (param == "STRONG" ? AttachType.High : AttachType.Normal), null, false, -1);
            if (rt == null) 
        ...
        static List<Pullenti.Ner.ReferentToken> TryAttachOrgs(Pullenti.Ner.Token t, int step)
        {
            if (t == null) 
                return null;
            if (t.Chars.IsLatinLetter && Pullenti.Ner.Core.MiscHelper.IsEngArticle(t)) 
            {
                List<Pullenti.Ner.ReferentToken> res11 = TryAttachOrgs(t.Next, step);
            ...
            {
                typ = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t, false);
                if (typ != null) 
                    t.InnerBool = true;
            ...
            Pullenti.Ner.ReferentToken rt00 = TryAttachSpec(t);
            if (rt00 == null) 
                    ...
                    if (((typ.Morph.Number & Pullenti.Morph.MorphNumber.Plural)) != Pullenti.Morph.MorphNumber.Undefined) 
                    {
                        ...
                        if (ok) 
                        {
                            if (!ok1 && typ.Coef > 0) 
                                ok1 = true;
                            if (ok1) 
                                rt = TryAttachOrg(t1.Next, AttachType.Multiple, typ, false, -1);
                        }
                        if (rt != null) 
                        {
                            _doPostAnalyze(rt);
                            ...
                            for (; t1 != null; t1 = t1.Next) 
                            {
                                ...
                                t1 = t1.Next;
                                Pullenti.Ner.Org.Internal.OrgItemTypeToken typ1 = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t1, true);
                                if (typ1 != null) 
                                {
                                    ok = false;
                                    break;
            ...
            if (typ != null && ((typ.IsDep || typ.CanBeDepBeforeOrganization))) 
            {
                ...
                if (rt == null) 
                    rt = TryAttachOrg(typ.EndToken.Next, AttachType.NormalAfterDep, null, false, -1);
            }
            Pullenti.Ner.Org.Internal.OrgAnalyzerData ad = OrganizationAnalyzer.GetData(t);
            ...
            if (((step == 0 && rt == null && tt != null) && !tt.Chars.IsAllLower && tt.Chars.IsCyrillicLetter) && tt.GetMorphClassInDictionary().IsUndefined) 
            {
                ...
                if (((s.StartsWith("ГУ") || s.StartsWith("РУ"))) && s.Length > 3 && ((s.Length > 4 || s == "ГУВД"))) 
                {
                    ...
                    Pullenti.Ner.Org.Internal.OrgItemTypeToken.RecalcData(tt);
                    ...
                    if (rt != null) 
                    {
                        ...
                        Pullenti.Ner.ReferentToken rt0 = TryAttachDepBeforeOrg(typ, rt);
                        if (rt0 != null) 
                        {
                            if (ad != null) 
                                rt.Referent = ad.RegisterReferent(rt.Referent);
                ...
                else if ((((((((((s[0] == 'У' && s.Length > 3 && tt.GetMorphClassInDictionary().IsUndefined)) || s == "ОВД" || s == "РОВД") || s == "ОМВД" || s == "ОСБ") || s == "УПФ" || s == "УФНС") || s == "ИФНС" || s == "ИНФС") || s == "УВД" || s == "УФМС") || s == "УФСБ" || s == "ОУФМС") || s == "ОФМС" || s == "УФК") || s == "УФССП") 
                {
                    ...
                    if (rt != null) 
                    {
                        ...
                        if (rt0 != null) 
                        {
                            ...
                            {
                                if ((((geo = IsGeo(rt0.EndToken.Next, false)))) != null) 
                                {
                                    if ((rt0.Referent as OrganizationReferent).AddGeoObject(geo)) 
                                        rt0.EndToken = GetGeoEndToken(geo, rt0.EndToken.Next);
                                }
                                else if (rt0.EndToken.WhitespacesAfterCount < 3) 
                                {
                                    ...
                                    {
                                        if ((((geo = IsGeo(nam.EndToken.Next, false)))) != null) 
                                        {
                                            if ((rt0.Referent as OrganizationReferent).AddGeoObject(geo)) 
                                                rt0.EndToken = GetGeoEndToken(geo, nam.EndToken.Next);
                                ...
                                if (tt.Previous != null && ((tt.Previous.Morph.Class.IsAdjective && !tt.Previous.Morph.Class.IsVerb)) && tt.WhitespacesBeforeCount == 1) 
                                {
                                    ...
                                    if (adj != null && !adj.StartsWith("УПОЛНОМОЧ") && !adj.StartsWith("ОПЕРУПОЛНОМОЧ")) 
                                    {
                                        ...
                                        if (rt0.BeginToken.Previous != null && rt0.BeginToken.Previous.IsHiphen && rt0.BeginToken.Previous.Previous != null) 
                                        {
                                            ...
                                            if (tt0.Chars.Equals(rt0.BeginToken.Chars) && (tt0 is Pullenti.Ner.TextToken)) 
                                            {
            ...
            if (rt == null && step == 0 && t != null) 
            {
                ...
                if (ok) 
                {
                    ...
                    else 
                    {
                        ...
                        if (br != null) 
                        {
                            Pullenti.Ner.ReferentToken rt11 = TryAttachOrg(t.Next, AttachType.Normal, null, false, -1);
            ...
            if (rt == null) 
            {
                if (Pullenti.Ner.Core.BracketHelper.CanBeStartOfSequence(t, false, false)) 
                {
                    ...
                    if (br != null) 
                    {
                        ...
                        {
                            if ((((typ = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t1, false)))) != null && typ.Root != null && typ.Root.Typ == Pullenti.Ner.Org.Internal.OrgItemTypeTyp.Prefix) 
                            {
                                ...
                                if (ok) 
                                {
                                    ...
                                    org.AddName(nam, true, null);
                                    Pullenti.Ner.ReferentToken rt11 = TryAttachOrg(br.BeginToken.Next, AttachType.Normal, null, false, -1);
                    ...
                    if (Pullenti.Ner.Core.BracketHelper.CanBeEndOfSequence(rt.EndToken, true, null, false)) 
                    {
                        ...
                        for (Pullenti.Ner.Token ttt = tt1; ttt != null; ttt = ttt.Next) 
                        {
                            ...
                            if (br == null) 
                                break;
                            bool addTyp = false;
                            Pullenti.Ner.ReferentToken rt1 = _TryAttachOrg_(ttt.Next.Next, ttt.Next.Next, null, true, AttachType.Normal, null, false);
                            if (rt1 == null || (rt1.EndChar < (br.EndChar - 1))) 
                            {
                                addTyp = true;
                                rt1 = _TryAttachOrg_(ttt.Next, ttt.Next, null, true, AttachType.High, null, false);
                            }
                            if (rt1 == null || (rt1.EndChar < (br.EndChar - 1))) 
                                break;
                            li.Add(rt1);
        ...
        static void _doPostAnalyze(Pullenti.Ner.ReferentToken rt)
        {
            ...
            if (o.Higher == null && o.m_TempParentOrg == null) 
            {
                ...
                {
                    Pullenti.Ner.ReferentToken rt1 = TryAttachOrg(rt.EndToken.Next, AttachType.NormalAfterDep, null, false, -1);
            ...
            for (; ttt != null; ttt = ttt.Next) 
            {
                ...
                if (ttt is Pullenti.Ner.TextToken) 
                {
                    ...
                    if (br) 
                    {
                        Pullenti.Ner.Org.Internal.OrgItemTypeToken otyp = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(ttt, true);
        ...
        static Pullenti.Ner.ReferentToken _tryAttachOrgByAlias(Pullenti.Ner.Token t)
        {
            if (t == null) 
                return null;
            Pullenti.Ner.Token t0 = t;
        ...
        static Pullenti.Ner.Token AttachMiddleAttributes(OrganizationReferent org, Pullenti.Ner.Token t)
        {
            Pullenti.Ner.Token te = null;
            for (; t != null; t = t.Next) 
            {
        ...
        static object IsGeo(Pullenti.Ner.Token t, bool canBeAdjective = false)
        {
            if (t == null) 
                return null;
            ...
            if (r != null) 
            {
                if (r.TypeName == GEONAME) 
                {
                    if ((t as Pullenti.Ner.ReferentToken).BeginToken.IsValue("ТЕРРИТОРИЯ", null)) 
                        return null;
            ...
            if (t.IsValue("ТЕРРИТОРИЯ", null) || t.IsValue("ПОСЕЛЕНИЕ", null)) 
                return null;
            Pullenti.Ner.ReferentToken rt = t.Kit.ProcessReferent("GEO", t, null);
            if (rt == null) 
                return null;
        ...
        static Pullenti.Ner.Token GetGeoEndToken(object geo, Pullenti.Ner.Token t)
        {
        ...
        static Pullenti.Ner.Token AttachTailAttributes(OrganizationReferent org, Pullenti.Ner.Token t, bool attachForNewOrg, AttachType attachTyp, bool isGlobal = false)
        {
            Pullenti.Ner.Token t1 = null;
            OrganizationKind ki = org.Kind;
            bool canHasGeo = true;
            ...
            for (; t != null; t = (t == null ? null : t.Next)) 
            {
                if (((t.IsValue("ПО", null) || t.IsValue("В", null) || t.IsValue("IN", null))) && t.Next != null) 
                {
                    ...
                    if (!canHasGeo) 
                        break;
                    object r = IsGeo(t.Next, false);
                    if (r == null) 
                        break;
                    if (!org.AddGeoObject(r)) 
                        break;
                    t1 = GetGeoEndToken(r, t.Next);
                    t = t1;
                    continue;
                }
                ...
                if (t.IsChar('(')) 
                {
                    ...
                    if (!isGlobal) 
                    {
                        ...
                        Pullenti.Ner.ReferentToken rt = TryAttachOrg(tt0, AttachType.High, null, false, 0);
                        if (rt == null) 
                            break;
                ...
                else if (attachTyp == AttachType.ExtOntology && Pullenti.Ner.Core.BracketHelper.CanBeStartOfSequence(t, true, false)) 
                {
                    ...
                    if (nam != null) 
                        org.AddName(nam, true, br.BeginToken.Next);
                    Pullenti.Ner.ReferentToken rt1 = TryAttachOrg(t.Next, AttachType.High, null, true, -1);
                    if (rt1 != null && rt1.EndToken.Next == br.EndToken) 
                    {
                        org.MergeSlots(rt1.Referent, true);
                        t = (t1 = br.EndToken);
            ...
            {
                Pullenti.Ner.Org.Internal.OrgItemTypeToken ty1 = Pullenti.Ner.Org.Internal.OrgItemTypeToken.TryAttach(t, false);
                if (ty1 != null && ty1.Root != null && ty1.Root.IsPurePrefix) 
                {
                    Pullenti.Ner.ReferentToken rt22 = TryAttachOrg(t, AttachType.Normal, null, false, -1);
                    if (rt22 == null) 
                    {
        ...
        static void CorrectOwnerBefore(Pullenti.Ner.ReferentToken res)
        {
            if (res == null) 
                return;
            ...
            for (Pullenti.Ner.Token t = res.EndToken.Next; t != null; t = t.Next) 
            {
                ...
                Pullenti.Ner.ReferentToken rt = TryAttachOrg(t, AttachType.Normal, null, false, -1);
                if (rt != null) 
        ...
        static Pullenti.Ner.ReferentToken CheckOwnership(Pullenti.Ner.Token t)
        {
            if (t == null) 
                return null;
            Pullenti.Ner.ReferentToken res = null;
                    ...
                    if (org2 != null) 
                    {
                        ...
                        else if (Pullenti.Ner.Org.Internal.OrgOwnershipHelper.CanBeHigher(org2, org, true)) 
                        {
                            ...
                            if (t0 != null && t0.IsChar(',')) 
                                t0 = t0.Previous;
                            Pullenti.Ner.ReferentToken rt = t.Kit.ProcessReferent("PERSON", t0, null);
        ...
        public override Pullenti.Ner.ReferentToken ProcessOntologyItem(Pullenti.Ner.Token begin)
        {
            if (begin == null) 
                return null;
            Pullenti.Ner.ReferentToken rt = TryAttachOrg(begin, AttachType.ExtOntology, null, begin.Previous != null, -1);
            if (rt != null) 
            {
        ...
        static Pullenti.Ner.ReferentToken TryAttachPoliticParty(Pullenti.Ner.Token t, bool onlyAbbrs = false)
        {
            if (!(t is Pullenti.Ner.TextToken)) 
                return null;
            ...
            else if ((((br = Pullenti.Ner.Core.BracketHelper.TryParse(t, Pullenti.Ner.Core.BracketParseAttr.No, 10)))) != null) 
            {
                ...
                if ((((nameTok = m_PoliticNames.TryParse(t.Next, Pullenti.Ner.Core.TerminParseAttr.No)))) != null) 
                    ...
                    for (Pullenti.Ner.Token tt = t.Next; tt != null && tt.EndChar <= br.EndChar; tt = tt.Next) 
                    {
                        ...
                        {
                            Pullenti.Morph.MorphClass mc = tt.GetMorphClassInDictionary();
                            if ((mc.Equals(Pullenti.Morph.MorphClass.Verb) || mc.Equals(Pullenti.Morph.MorphClass.Adverb) || mc.IsPronoun) || mc.IsPersonalPronoun) 
                            {
                                coef = 0;
                                break;
                            }
            ...
            else if (root != null) 
            {
                for (Pullenti.Ner.Token tt = t; tt != null; tt = tt.Next) 
                {
                    ...
                    if (tt.IsAnd) 
                    {
                        ...
                        if (npt2 != null && m_PoliticSuffs.TryParse(npt2.EndToken, Pullenti.Ner.Core.TerminParseAttr.No) != null && npt2.EndToken.Chars.Equals(tt.Previous.Chars)) 
                            continue;
                        break;
                    }
                    ...
                    if (co == 0) 
                    {
                        ...
                        if (((wordsAfter > 0 && npt.EndToken.Chars.Equals(tt.Previous.Chars))) || ((lastSuf != null && lastSuf.Termin.Tag != null)) || ((tt.Previous == root && npt.EndToken.Chars.IsAllLower && npt.Morph.Number == Pullenti.Morph.MorphNumber.Plural) && root.Chars.IsCapitalUpper)) 
                        {
                            Pullenti.Ner.ReferentToken pp = tt.Kit.ProcessReferent("PERSON", tt, null);
                            if (pp != null) 
                                break;
                            wordsAfter++;
                        }
