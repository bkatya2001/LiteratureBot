...
namespace Pullenti.Ner.Org
{
    ...
    public class OrganizationReferent : Pullenti.Ner.Referent
    {
        ...
        {
            return string.Format("{0} {1}", Kind, this.ToString(true, Pullenti.Morph.MorphLang.Unknown, 0));
        }
        ...
        internal bool AddGeoObject(object r)
        {
            ...
            {
                if (((r as Pullenti.Ner.ReferentToken).GetReferent() is Pullenti.Ner.Geo.GeoReferent) || ((r as Pullenti.Ner.ReferentToken).GetReferent() is Pullenti.Ner.Address.StreetReferent)) 
                {
