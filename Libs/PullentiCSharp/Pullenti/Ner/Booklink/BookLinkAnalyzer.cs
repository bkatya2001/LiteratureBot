    ...
    public class BookLinkAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        public override Dictionary<string, byte[]> Images
        {
            get
            {
                ...
                res.Add(Pullenti.Ner.Booklink.Internal.MetaBookLink.ImageId, Pullenti.Ner.Decree.Internal.ResourceHelper.GetBytes("booklink.png"));
                res.Add(Pullenti.Ner.Booklink.Internal.MetaBookLinkRef.ImageId, Pullenti.Ner.Decree.Internal.ResourceHelper.GetBytes("booklinkref.png"));
                res.Add(Pullenti.Ner.Booklink.Internal.MetaBookLinkRef.ImageIdInline, Pullenti.Ner.Decree.Internal.ResourceHelper.GetBytes("booklinkrefinline.png"));
                res.Add(Pullenti.Ner.Booklink.Internal.MetaBookLinkRef.ImageIdLast, Pullenti.Ner.Decree.Internal.ResourceHelper.GetBytes("booklinkreflast.png"));
                return res;
            }
        }
        ...
        static List<Pullenti.Ner.ReferentToken> TryParse(Pullenti.Ner.Token t, bool isInLit, int maxChar = 0)
        {
            ...
            for (; t != null; t = t.Next) 
            {
                ...
                Pullenti.Ner.Booklink.Internal.TitleItemToken tit = Pullenti.Ner.Booklink.Internal.TitleItemToken.TryAttach(t);
                if (tit != null) 
                {
                    if ((tit.Typ == Pullenti.Ner.Booklink.Internal.TitleItemToken.Types.Typ && tn0 == t && br == null) && Pullenti.Ner.Core.BracketHelper.CanBeStartOfSequence(tit.EndToken.Next, true, false)) 
                    {
                ...
                {
                    if ((((tit = Pullenti.Ner.Booklink.Internal.TitleItemToken.TryAttach(t.Next)))) != null) 
                    {
                        if (tit.Typ == Pullenti.Ner.Booklink.Internal.TitleItemToken.Types.Typ) 
                            break;
                    }
                    bool stop = true;
                    int words = 0;
            ...
            {
                List<Pullenti.Ner.Person.Internal.PersonItemToken> pits0 = Pullenti.Ner.Person.Internal.PersonItemToken.TryAttachList(rr.BeginToken, Pullenti.Ner.Person.Internal.PersonItemToken.ParseAttr.CanInitialBeDigit, 10);
        ...
        {
            Pullenti.Ner.Booklink.Internal.MetaBookLink.Initialize();
