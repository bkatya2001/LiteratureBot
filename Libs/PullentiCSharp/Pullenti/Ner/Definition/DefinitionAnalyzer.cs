...
namespace Pullenti.Ner.Definition
{
    ...
    public class DefinitionAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        public override void Process(Pullenti.Ner.Core.AnalysisKit kit)
        {
            ...
            if (kit.BaseLanguage.Equals(Pullenti.Morph.MorphLang.EN)) 
            {
            ...
            for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next) 
            {
                ...
                if (Pullenti.Ner.Core.MiscHelper.CanBeStartOfSentence(t)) 
                    ok = true;
                else if (((t.IsValue("ЧТО", null) && t.Next != null && t.Previous != null) && t.Previous.IsComma && t.Previous.Previous != null) && t.Previous.Previous.Morph.Class.Equals(Pullenti.Morph.MorphClass.Verb)) 
                {
                    ok = true;
                    t = t.Next;
            ...
            for (; t != null; t = t.Next) 
            {
                ...
                if (!(t is Pullenti.Ner.TextToken)) 
                {
                    ...
                    if (r != null && ((r.TypeName == "DECREE" || r.TypeName == "DECREEPART"))) 
                    {
                        ...
                        if (l0 == null) 
                        {
                            if ((t.Next != null && t.Next.GetMorphClassInDictionary().Equals(Pullenti.Morph.MorphClass.Verb) && t.Next.Next != null) && t.Next.Next.IsComma) 
                            {
                                t = t.Next.Next;
